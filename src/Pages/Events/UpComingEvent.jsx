...
import { UpComingEventData } from "../../APIs/EventAPI";

const UpComingEvent = () => {
  const [upcomingeventdata] = useState(UpComingEventData);
  ...
  return (
    <>
      <div className="pt-[6rem] pb-[4rem] px-[20rem] max-xl:px-[5rem] max-md:px-[2rem] w-[100%] relative object-cover">
